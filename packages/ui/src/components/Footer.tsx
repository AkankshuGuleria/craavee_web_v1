...
// /ssr entry point — see OpsShell.tsx / PHASE_2B_IMPLEMENTATION_REPORT.md
// for why the bare package breaks Next.js's server/RSC build pass.
import { Sparkle, Phone } from "@phosphor-icons/react/ssr";
